export default function DiscussThreadPage({ params }) {
  return (
    <div className="flex-1 bg-background min-h-[calc(100vh-56px)] text-white font-sans flex items-center justify-center">
      <div className="text-center p-10 bg-[#282828] rounded-xl border border-[#3e3e3e] max-w-2xl w-full">
